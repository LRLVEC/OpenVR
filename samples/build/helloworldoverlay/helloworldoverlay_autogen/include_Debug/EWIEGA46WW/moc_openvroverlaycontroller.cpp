...
#include <memory>
#include "../../../../../helloworldoverlay/openvroverlaycontroller.h"
...
void COpenVROverlayController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<COpenVROverlayController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject COpenVROverlayController::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_COpenVROverlayController.data,
    qt_meta_data_COpenVROverlayController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
